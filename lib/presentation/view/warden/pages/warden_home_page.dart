  ...
  Widget build(BuildContext context) {
    ...
    final row0 = [
      ExpandableStatCardData(
        ...
        iconColor: Color.fromRGBO(36, 99, 235, 1.0),
        iconBgColor: Color.fromRGBO(233, 239, 252, 0.8),
        value: stats.count,
        valueLabel: "Active Requests",
        title: "Active Requests",
        breakdown: const [], // no details
      ),
      ExpandableStatCardData(
        icon: Icons.assignment_turned_in_outlined,
        iconColor: Color.fromRGBO(249, 116, 21, 1.0),
        iconBgColor: Color.fromRGBO(254, 241, 231, 1.0),
    ...
    final row1 = [
      ExpandableStatCardData(
        ...
        iconColor: Color.fromRGBO(239, 67, 67, 1.0),
        iconBgColor: Color.fromRGBO(253, 236, 236, 1.0),
